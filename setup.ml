...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1206ef7052ee6e75490ef03c8be85854) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         {
            OCamlbuildCommon.plugin_tags = Some "package(mybuild)";
            extra = ["-use-ocamlfind"; "-j"; "0"]
         };
     test =
       [
          ("main",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$sqlgg", ["-test"]))];
          ...
          ("regression",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("sh", ["./run_test"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "http://ygrek.org.ua/p/sqlgg/";
          bugreports = None;
          synopsis = "SQL guided (code) generator";
          description = None;
          tags = [];
          categories = [];
          files_ab = ["src/version_release.ml.ab"];
          sections =
            [
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Sqlgg_traits"; "Sqlgg_io"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sqlgg";
                      lib_findlib_name = Some "traits";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build mariadb traits implementation";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build mysql traits implementation";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build sqlite3 traits implementation";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "sqlgg_mariadb";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "mariadb", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "impl/ocaml/mariadb";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("mariadb", None);
                           InternalLibrary "sqlgg_traits"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "menhir"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules = ["Sqlgg_mariadb"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sqlgg";
                      lib_findlib_name = Some "mariadb";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://github.com/ygrek/sqlgg.git";
     ...
     oasis_digest = Some "G\129\241)_\147&\021\231\020\148\130NT\246\018";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
