...
(* OASIS_START *)
(* DO NOT EDIT (digest: 68bb3d7f88a4845948a24d6b1de5c58b) *)
(*
...
let setup_t =
  {
     ...
     oasis_digest = Some "\199?f\163\170\245#\247T\229\235\219\139\214\2310";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
