Change a column type (INT -> BIGINT): down restores the original type. The
committed migrations.sql / migrations.ml are the generation result; the generator
must still reproduce them (no diff output == equal).
