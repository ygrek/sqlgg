...
-- Test 20: Star expansion in dynamic_select mode
-- [sqlgg] dynamic_select=true
-- @all_cols_runtime
SELECT * FROM products WHERE id = @id;

-- Test 21: Star + expression in dynamic_select mode
-- [sqlgg] dynamic_select=true
-- @all_cols_plus_expr_runtime
SELECT *, id + 2 AS id_plus FROM products WHERE id = @id;

-- Test 22: Multiline select-list formatting
-- [sqlgg] dynamic_select=true
-- @multiline_cols_runtime
SELECT
    id,
    name,
    price,
